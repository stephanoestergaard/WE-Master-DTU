...
TYPE, PUBLIC :: ControlParameters
    ...
    REAL(8), DIMENSION(:), ALLOCATABLE  :: Fl_Kp                        ! Nacelle velocity proportional feedback gain [s], collective pitch and IPC
...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(8)                             :: FLIPC_PitCom(3)              ! Tower fore-aft vibration damping pitch contribution [rad]
...
! Variables used for debug purposes
    ...
    REAL(8)                             :: axisTilt_1P 
    REAL(8)                             :: axisYaw_1P          
    REAL(8)                             :: IntAxisTilt_1P
    REAL(8)                             :: IntAxisYaw_1P
    ! Relevant for Fl IPC
    REAL(8)                             :: Fl_IPC_Gain
    ! Statemachine
    REAL(8)                             :: GenArTq
